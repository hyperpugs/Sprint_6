...
class TestSmoke:
    ...
    @pytest.mark.parametrize('data', [
        ["Дмитрий", "Иванов", "пр. Мира 2", "Лубянка", "77007009858", "02.10.2024", "двое суток", "black",
         "Как получится"],
    ...
    @allure.description('Проверяем оформления заказа по кнопке "Заказать" в центре сайта, '
                        ...
                        'проверяем переход на главную страницу Дзена с помощью логотипа Яндекса')
    @pytest.mark.parametrize('data', [
        ["Иван", "Иванов", "ул. Старовиленская 10а", "Черкизовская", "74561234567", "26.10.2024", "двое суток",
         "black", "Вечером"],
        ["Алина", "Игнатова", "пл. Свободы 2а", "Сокольники", "76146399170", "21.10.2024", "двое суток", "grey",
         "К 14:00"]])
